  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        ...
        const systemPrompt = isBusinessCall
        ...
        const greetingMessage = isBusinessCall
