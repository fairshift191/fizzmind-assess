  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        ...
        const systemPrompt = isRedesignCall
        ...
        const greetingMessage = isRedesignCall
