  ...
  useEffect(() => {
    ...
    async function init() {
      try {
        ...
        const systemPrompt = isChatHistoryCall
        ...
        const greetingMessage = isChatHistoryCall
